package com.akhutornoy.shoppinglist.createroduct.adapter;
...
public class AddProductTypeAdapter extends RecyclerView.Adapter<AddProductTypeAdapter.ProductViewHolder> {
